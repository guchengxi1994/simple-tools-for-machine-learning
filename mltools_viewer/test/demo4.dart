  ...
  Widget build(BuildContext context) {
    return Actions(
      ...
      actions: <Type, Action<Intent>>{
        ...
        ShowSearchDialog:
            ShowSearchDialogAction(context: context, controller: controller),
      },
...
class ShowSearchDialog extends Intent {
  const ShowSearchDialog();
}

class ShowSearchDialogAction extends Action<ShowSearchDialog> {
  final BuildContext context;
  ShowSearchDialogAction({required this.context, required this.controller});
  final TextEditingController controller;

  @override
  Object? invoke(covariant ShowSearchDialog intent) {
    debugPrint("这里要弹出弹窗");
    return null;
  }
}
      ...
      home: Shortcuts(
        ...
        shortcuts: <LogicalKeySet, Intent>{
          ...
          LogicalKeySet(LogicalKeyboardKey.control, LogicalKeyboardKey.alt,
              LogicalKeyboardKey.keyF): const ShowSearchDialog(),
        },
