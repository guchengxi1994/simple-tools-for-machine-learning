...
w=x!=null?new A.dH(x.gl2(x)):C.ht
break
case 0:x=d.d
w=d.c
if(x!=null){v=w==null?null:w.gl2(w)
...
D9(d,e,f){return this.e.dP(new A.x(0,0,0+d.a,0+d.b),f).B(0,e)},
vv(d){return new B.alX(this,d)}}
B.alX.prototype={
a48(d,e){var x,w,v,u=this
...
if(w!=null){v=u.r
v.toString
v.sxP(w.Nj(0,d,e))}w=x.d
if(w!=null){if(u.w==null){u.w=w.length
u.y=A.a5(new A.a0(w,new B.alY(),A.Z(w).i("a0<1,K4>")),!0,y.m)}u.x=A.a5(new A.a0(w,new B.alZ(u,d,e),A.Z(w).i("a0<1,Ko>")),!0,y.c)}if(u.r!=null||u.w!=null)u.e=x.e.dP(d,e)
if(x.c!=null)u.f=x.e.hg(d,e)
u.c=d
u.d=e},
...
if(x!=null)x.n(0)
this.FN(0)},
hP(d,e,f){var x=this,w=f.e,v=e.a,u=e.b,t=new A.x(v,u,v+w.a,u+w.b),s=f.d
x.a48(t,s)
x.a5y(d)
if(x.r!=null){w=A.a(x.e,"_outerPath")
v=x.r
v.toString
d.bP(0,w,v)}x.a3r(d,f)
x.b.e.fB(d,t,s)}}
var z=a.updateTypes([])
B.alY.prototype={
$1(d){return d.hS()},
$S:406}
B.alZ.prototype={
$1(d){return this.a.b.e.dP(this.b.cn(d.b).dL(d.d),this.c)},
...
$__dart_deferred_initializers__["7sBjckp/+rX91wWV2WmD6qRreSc="] = $__dart_deferred_initializers__.current
